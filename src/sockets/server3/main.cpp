 ...
 * increments it by 5, and sends the modified character back.
 */
 ...
 * the server reads a character, increments it by 5, and sends the updated
 * character back to the client. This process repeats indefinitely until the
 * server is stopped.
 *
...
int main()
{
  ...
  while (1)
  {
    ...
    // Increment the received character by 5
    ch += 5;
